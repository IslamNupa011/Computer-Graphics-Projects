...
void loadImage()
{
	...
	wallImg = LoadBitmapImage("images/wall8.bmp");
	wallTop = LoadBitmapImage("images/wall9.bmp");
}
...
void solidCube2Part(double n) {
	solidCube1Part(n);
	glRotated(90, 1, 0, 0);
	glTranslated(0, -n, -n);
	solidCube1Part(n);
}
void customSolidCube(double n) {
	glPushMatrix(); {
		glTranslated(0, -n/2, 0);
		solidCube2Part(n/2);
		glRotated(90, 1, 0, 0);
		glTranslated(0, -n/2, -n/2);
		solidCube2Part(n/2);
	}glPopMatrix();
